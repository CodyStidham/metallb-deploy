pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/CodyStidham/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('stidhalt-225')   // <---- Change this to match your kubernetes cluster credentials
    }
